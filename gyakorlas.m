%% egyszerű függvény készítés egy fájlba, és annak meghívás:
...
%% 1. eset plot
% x = tól:lépésköz:ig, y = a függvény, és meg kell adni neki az x változót 
x = -10:1:10;
y = fgv1(x);
plot(x,y)
...
fplot(@fgv1)
ax = gca(); %beépített függvény, a grafikus beállításokhoz
...
ax.YAxisLocation = "origin";
ax.XLim = [-10, 10];
ax.YLim = [-1, 20];%% fixpont iteráció egyenletek megoldására
...
b = [-2, -4, 0, 3]'; % ' a transzponálás,  oszlop vektor legyen. vagy ;-vel választom el az elemeket
